...
* [gateway.yaml](https://github.com/hinichijou/DevOpswithKubernetesManifests/tree/4.10/infrastructure/manifests/gateway.yaml): defines the gateway resource for cluster service access.
* [namespaces.yaml](https://github.com/hinichijou/DevOpswithKubernetesManifests/tree/4.10/infrastructure/manifests/namespaces.yaml): defines all of the project namespaces and a rule if the namespace is allowed to attach routes to the gateway.
* [persistentvolumes.yaml](https://github.com/hinichijou/DevOpswithKubernetesManifests/tree/4.10/infrastructure/manifests/persistentvolumes.yaml): defines the project persistent volumes which the applications in turn claim.
