...
[push_image_changes_on_dispatch.yaml](https://github.com/hinichijou/DevOpswithKubernetesManifests/tree/5.1/.github/workflows/push_image_changes_on_dispatch.yaml) defines the GitHub workflow. The workflow is triggered by the [source code repository](https://github.com/hinichijou/DevOpswithKubernetes/tree/5.1/.github/workflows/) that builds the application images. The workflow edits the `kustomization.yaml` of todo_app, log output ping-pong application and/or dummysite and commits and tags the changes if necessary.
